...
This apporach follows the [Mediator pattern](https://refactoring.guru/design-patterns/mediator) offering a way to communicate between components without having to pass props down the component tree.
